...
---
Latest release: 
<a href="https://github.com/MathisBurger/ChocolateCSS/releases/download/v1.0.2-beta/">Download</a>

CSS:
```css
@import url("https://github.com/MathisBurger/ChocolateCSS/releases/download/v1.0.2-beta/chocolate.min.css");
```

HTML:
```html
<link rel="stylesheet" href="https://github.com/MathisBurger/ChocolateCSS/releases/download/v1.0.2-beta/chocolate.min.css">
```
